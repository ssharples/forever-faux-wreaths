          ...
          <div className="container-narrow">
            <div className="prose prose-charcoal max-w-none">
              ...
              <p>
                ...
                Wreaths website (foreverfauxwreaths.co.uk) and any purchases
                made through it. By using our website or placing an order, you
                agree to be bound by these terms.
              </p>
              <p>
                Forever Faux Wreaths is a sole trader business operated by
                Claire, based in Preston, Lancashire, United Kingdom.
              </p>
              ...
              <p>
                ...
                to discontinue products without notice. If a product becomes
                unavailable after you have placed an order, we will contact you
                to offer alternatives or a full refund.
              </p>
              ...
              <p>
                We accept payment through Stripe Checkout. Available payment
                methods are shown at checkout, and all payments must be received
                before dispatch. Stripe processes payments securely; we do not
              ...
              <p>
                ...
                applicable. Delivery charges are shown separately at checkout.
                We reserve the right to change prices without notice, but any
              ...
              <ul>
                <li>Made-to-order preparation time: usually 1-2 weeks</li>
                <li>Standard delivery: after dispatch</li>
              ...
              <p>
                ...
                requirements. After submitting an enquiry, we will provide a
                quote and timeline. Work begins only after you approve the quote
              ...
              <p>
                Additional features such as ribbons (+£5) and complex designs
              ...
              <p>
                ...
                Bespoke items are non-refundable as they are made specifically
                for you.
              </p>
              ...
              <p>
                ...
                with photographs. We will arrange a replacement or full refund
                at no extra cost.
              </p>
              ...
              <p>
                ...
                specific requirements. This does not affect your statutory
                rights if the item is faulty.
              </p>
              ...
              <p>
                All content on this website, including images, text, designs,
                and logos, is the property of Forever Faux Wreaths and is
              ...
              <p>
                ...
                obligations where such failure or delay results from events
                beyond our reasonable control, including but not limited to
                natural disasters, pandemic, strikes, or supply chain
                disruptions.
              </p>
